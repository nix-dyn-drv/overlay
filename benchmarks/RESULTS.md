...
5. **A freshly-linked executable loses its execute bit under
   ...
   (Makefile and cmake) and isn't specific to libb64's small case. Still
   open (confirmed against dyn-drvs dc07a0a too).
