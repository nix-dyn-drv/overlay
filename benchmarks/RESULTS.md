...
Thirteen bugs in `accelerate.mkAcceleratedStdenv`/`phases.split`, beyond what
...
12. **A linker version-script (`-Wl,--version-script,<absolute-path>`)
...
13. **Bare `-l<name>` link args are never resolved to their producing
